...
const readShortPosts = async (dbClient, filters, filterSchema, offset = "0", limit = shortPostConfig_1.SHORT_POST_READ_LIMIT.toString(), sortBy = "date", userId) => {
  ...
  `;
    const values = [
        userId,
        ...((filterKeys === null || filterKeys === void 0 ? void 0 : filterKeys.map((key) => filters[key])) || []),
    ];
